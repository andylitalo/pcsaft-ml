...
- [x] Heteroscedasticity assumption verified
- [x] Target distribution skewness reported
- [x] RF and XGBoost trained on both raw and log targets
- [x] Back-transform bias quantified (smearing factor)
- [x] Esper holdout comparison with R2, MAE, sMAPE
- [x] Repeated 5-fold CV (5x3) with paired t-tests
- [x] Fluorinated validation with paired bootstrap and Wilcoxon
- [x] At least 5 figures generated
- [x] Report written
